...
{
    public sealed class CurveLoopVisualizationServer : IDirectContext3DServer
    {
        ...
        public string GetName() => "CurveLoop visualization server";
        public string GetDescription() => "CurveLoop geometry visualization";
